...
# question #1
curl -d '{ "title": "Sir Lancelot and the bridge keeper, part 1", "question": "What... is your name?", "answer": "Sir Lancelot of Camelot"}' -H 'Content-Type: application/json' http://localhost:5000/questions && echo
...
# question #2
curl -d '{ "title": "Sir Lancelot and the bridge keeper, part 2", "question": "What... is your quest?", "answer": "To seek the holy grail"}' -H 'Content-Type: application/json' http://localhost:5000/questions && echo
...
# question #3
curl -d '{ "title": "Sir Lancelot and the bridge keeper, part 3", "question": "What... is your favorite colour?", "answer": "Blue"}' -H 'Content-Type: application/json' http://localhost:5000/questions && echo
...
curl -d '{ "title": "delete this question", "question": "What did it ever do to deserve deletion?", "answer": "nothing, really"}' -H 'Content-Type: application/json' http://localhost:5000/questions && echo
...
# updating questions
curl -X 'PUT' -d '{ "title": "[modified] Sir Lancelot and the bridge keeper, part 3", "question": "[modified] What... is your favorite colour?", "answer": "[modified] Blue"}' -H 'Content-Type: application/json' http://localhost:5000/questions/3 && echo
...
curl -X 'PUT' -d '{ "answer": "REDACTED ;p"}' -H 'Content-Type: application/json' http://localhost:5000/questions/3/distractors/3 && echo
