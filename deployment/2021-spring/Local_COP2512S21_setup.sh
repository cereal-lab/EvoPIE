...
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "for(int i=0 ; i < data.length ; i++){ data[i] = (data[i] % 2 == 0)?data[i]:data[i]+1; }"}'   #D7
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "for(int i=0 ; i < data.length ; i++){ if(data[i] % 2 != 0) data[i]++; }"}'   #D8
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "for(int v:data){ if(v % 2 != 0) v++; }"}'   #D9
...
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "int rnd = 23 + (int)(Math.random()*19);"}'   #D10
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "int rnd = 23 + (int)(Math.random()*42);"}'   #D11
curlit  'Added distractor'          "/questions/2/distractors"      '{ "answer": "int rnd = 23 + (int)(Math.random()*43);"}'   #D12
...
curlit  'Quiz Created'              "/quizzes"                      '{ "title": "Extra Credit Quiz", "description": "TODO", "questions_ids":[1, 2, 3, 4, 5]}'
