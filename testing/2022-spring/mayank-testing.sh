...
curlit "signed up instructor"       "/signup"           '{ "email": "instructor@usf.edu", "password": "instructor", "retype": "instructor","firstname": "John", "lastname": "Keating" }'
curlit "signed up student #1"       "/signup"           '{ "email": "student1@usf.edu", "password": "student1", "retype": "student1","firstname": "Anakin", "lastname": "Skywalker" }'
curlit "signed up student #2"       "/signup"           '{ "email": "student2@usf.edu", "password": "student2", "retype": "student2", "firstname": "Ahsoka", "lastname": "Tano" }'
curlit "signed up student #3"       "/signup"           '{ "email": "student3@usf.edu", "password": "student3", "retype": "student3","firstname": "Obi-Wan", "lastname": "Kenobi" }'
...
##curlit  'Added distractor'          "/questions/4/distractors"      '{ "answer": "Sir Galahad of Camelot"}'         #D10
##curlit  'Added distractor'          "/questions/4/distractors"      '{ "answer": "Sir Arthur of Camelot"}'          #D11
##curlit  'Added distractor'          "/questions/4/distractors"      '{ "answer": "Sir Bevedere of Camelot"}'        #D12
##curlit  'Added distractor'          "/questions/4/distractors"      '{ "answer": "Sir Robin of Camelot"}'           #D13
